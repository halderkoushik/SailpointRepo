 ...
 * <p>
 * The Vfs class throws tons of errors and clogs output. This class basically 'tells' Vfs to ignore certain
 * file types and hence prevents the lovely warning messages.
 */
...
public class ReflectionsHelper {
    ...
    public static void registerUrlTypes() {
        ...
        urlTypes.add(new EmptyIfFileEndingsUrlType(".mar", ".jnilib", ".so", ".xml", ".dtd", ".txt", ".properties"));
